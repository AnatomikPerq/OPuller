...
export const TIPS: Array<[string, string]> = [
  ...
  ['Reshape', 'Liquify brushes — Warp (Shift+R), Twirl, Pucker, Bloat, Scallop, Crystallize, Wrinkle — push, twist and ripple paths under an elliptical brush. Alt-drag resizes the brush.'],
  ['Trace', 'Object > Image > Image Trace turns a placed picture into vector shapes: pick a preset, tune Paths / Corners / Noise with the live preview, then Trace.'],
