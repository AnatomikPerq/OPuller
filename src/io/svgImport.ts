...
export function importSvg(svgText: string, opts: SvgImportOptions = {}): SvgImportResult {
  ...
  const scratch: Document = { id: 'import', name: opts.name ?? 'Import', units: 'px', artboards: [], layers: [], nodes: {}, guides: [], swatches: [], patterns: [], grid: { size: 50, subdivisions: 5, color: '#888888', style: 'lines' }, meta: { created: '', modified: '', generator: 'OPuller', version: 1 } };
